...
class WorkSlotModel(DateTemplate, Base):
    ...
    slot_id = Column(Integer, ForeignKey("event_room_slots.id", ondelete="CASCADE"), nullable=False, primary_key=True)
    ...
    __table_args__ = (UniqueConstraint("slot_id", "work_id", name="_slot_work_uc"),)
