...
async def delete_all_work_assignments(
    slots_configuration_service: SlotsConfigurationServiceDep,
) -> None:
...
async def assign_works_to_slots(
    parameters: AssignWorksParametersSchema,
    slots_configuration_service: SlotsConfigurationServiceDep,
) -> None:
    logger.info(
        f"Assigning works to slots for event {slots_configuration_service.event_id} with parameters: {parameters}"
    )
...
async def get_slots_with_works(
    slots_configuration_service: SlotsConfigurationServiceDep,
) -> List[SlotWithWorksSchema]:
